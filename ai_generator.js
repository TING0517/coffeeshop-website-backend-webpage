...
//         headers: {
//           Authorization:
//             "Bearer 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",
...
//             },
//             { role: "user", content: `品名: ${name}, 售價: ${price}` },
//           ],
...
//   } catch (err) {
//     alert("AI 生成失敗，請確認 API Key 或網路狀況");
//     console.error(err);
//   } finally {
//     $(".loading-spinner").hide();
//     $(".btn-text").text("開始 AI 生成內容");
            ...
            const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
                ...
                body: JSON.stringify({
                    ...
                    messages: [
                        ...
                        { role: "user", content: `品名: ${nameEl.value}, 售價: ${priceEl.value}, 產品關鍵字: ${keysEl.value}` },
                    ],
                    response_format: { type: "json_object" },
                }),
            });
